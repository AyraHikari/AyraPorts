...
.method private buildTaskList()V
    ...
    .line 258
    :cond_6
    iget-object v0, p0, Lflyme/support/v7/widget/GapWorker;->mTasks:Ljava/util/ArrayList;

    sget-object v1, Lflyme/support/v7/widget/GapWorker;->sTaskComparator:Ljava/util/Comparator;
...
.method private flushTaskWithDeadline(Lflyme/support/v7/widget/GapWorker$Task;J)V
    ...
    .line 344
    iget-object v0, p1, Lflyme/support/v7/widget/RecyclerView$ViewHolder;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
...
.method private prefetchPositionWithDeadline(Lflyme/support/v7/widget/RecyclerView;IJ)Lflyme/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 281
    :cond_0
    iget-object v0, p1, Lflyme/support/v7/widget/RecyclerView;->mRecycler:Lflyme/support/v7/widget/RecyclerView$Recycler;
    ...
    .line 285
    invoke-virtual {v0, p2, v1, p3, p4}, Lflyme/support/v7/widget/RecyclerView$Recycler;->tryGetViewHolderForPositionByDeadline(IZJ)Lflyme/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {p2}, Lflyme/support/v7/widget/RecyclerView$ViewHolder;->isInvalid()Z
    ...
    .line 292
    iget-object p3, p2, Lflyme/support/v7/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    invoke-virtual {v0, p3}, Lflyme/support/v7/widget/RecyclerView$Recycler;->recycleView(Landroid/view/View;)V

    goto :goto_0

    .line 298
    :cond_1
    invoke-virtual {v0, p2, v1}, Lflyme/support/v7/widget/RecyclerView$Recycler;->addViewHolderToRecycledViewPool(Lflyme/support/v7/widget/RecyclerView$ViewHolder;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    :goto_0
    invoke-virtual {p1, v1}, Lflyme/support/v7/widget/RecyclerView;->onExitLayoutOrScroll(Z)V
...
.method postFromTraversal(Lflyme/support/v7/widget/RecyclerView;II)V
    ...
    .line 184
    :cond_0
    iget-object p1, p1, Lflyme/support/v7/widget/RecyclerView;->mPrefetchRegistry:Lflyme/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;

    invoke-virtual {p1, p2, p3}, Lflyme/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;->setPrefetchVector(II)V
