...
.field protected mWaitProgressDialog:Lcom/meizu/open/pay/base/ui/WaitProgressDialog;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/meizu/open/pay/base/BaseActivity;->mUiHandler:Landroid/os/Handler;
...
.method public dismissWaitProgressDialog()V
    ...
    .line 148
    iget-object v0, p0, Lcom/meizu/open/pay/base/BaseActivity;->mWaitProgressDialog:Lcom/meizu/open/pay/base/ui/WaitProgressDialog;
...
.method public isWaitProgressDialogShowing()Z
    .locals 1
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 30
    invoke-virtual {p0}, Lcom/meizu/open/pay/base/BaseActivity;->hideActionBar()Z
    ...
    .line 35
    :cond_0
    invoke-virtual {p0}, Lcom/meizu/open/pay/base/BaseActivity;->setHomeAsUpEnabled()V

    .line 37
    :cond_1
    :goto_0
    invoke-direct {p0}, Lcom/meizu/open/pay/base/BaseActivity;->setSoftInputMode()V

    .line 38
    invoke-static {p0}, Lcom/meizu/open/pay/sdk/util/WidgetHelper;->getWaitProgressDialog(Landroid/content/Context;)Lcom/meizu/open/pay/base/ui/WaitProgressDialog;

    move-result-object p1

    iput-object p1, p0, Lcom/meizu/open/pay/base/BaseActivity;->mWaitProgressDialog:Lcom/meizu/open/pay/base/ui/WaitProgressDialog;

    .line 39
    invoke-virtual {p0}, Lcom/meizu/open/pay/base/BaseActivity;->initWaitProgressDialog()V
...
.method protected onDestroy()V
    ...
    .line 45
    invoke-virtual {p0}, Lcom/meizu/open/pay/base/BaseActivity;->dismissWaitProgressDialog()V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 86
    invoke-virtual {p0}, Lcom/meizu/open/pay/base/BaseActivity;->onHomePressed()Z
...
.method public setContentView(I)V
    ...
    .line 51
    invoke-virtual {p0}, Lcom/meizu/open/pay/base/BaseActivity;->isTranslucent()Z

    move-result p1

    invoke-virtual {p0, p1}, Lcom/meizu/open/pay/base/BaseActivity;->setTranslucentStatus(Z)V

    .line 53
    invoke-virtual {p0}, Lcom/meizu/open/pay/base/BaseActivity;->getFitActionBarFlag()I
    ...
    .line 55
    invoke-static {p0, p1}, Lcom/meizu/open/pay/sdk/util/SmartBarUtil;->fitActionBarForActivity(Landroid/app/Activity;I)V

    :cond_0
    return-void
.end method

.method protected setHomeAsUpEnabled()V
    .locals 2
...
.method public setWaitProgressDialogCancelable(Z)V
    .locals 1
...
.method public setWaitProgressDialogMsg(Ljava/lang/String;)V
    .locals 1
