...
.method constructor <init>(Lflyme/support/v7/widget/RecyclerView;)V
    ...
    iput-object v0, p0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mScroller:Landroid/widget/OverScroller;

    return-void
.end method

.method static synthetic access$400(Lflyme/support/v7/widget/RecyclerView$ViewFlinger;)Landroid/widget/OverScroller;
    .locals 0

    .line 4968
    iget-object p0, p0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mScroller:Landroid/widget/OverScroller;
...
.method public fling(II)V
    ...
    .line 5148
    iget-object v1, p0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mScroller:Landroid/widget/OverScroller;
...
.method public run()V
    ...
    .line 4995
    iget-object v1, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mScroller:Landroid/widget/OverScroller;
    ...
    invoke-static {v3}, Lflyme/support/v7/widget/RecyclerView;->access$500(Lflyme/support/v7/widget/RecyclerView;)[I
    ...
    .line 5001
    iget v5, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mLastFlingX:I

    sub-int v13, v11, v5

    .line 5002
    iget v5, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mLastFlingY:I

    sub-int v14, v12, v5

    .line 5005
    iput v11, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mLastFlingX:I

    .line 5006
    iput v12, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mLastFlingY:I
    ...
    invoke-virtual/range {v5 .. v10}, Lflyme/support/v7/widget/RecyclerView;->dispatchNestedPreScroll(II[I[II)Z
    ...
    invoke-virtual {v3}, Lflyme/support/v7/widget/RecyclerView;->startInterceptRequestLayout()V

    .line 5016
    iget-object v3, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    invoke-virtual {v3}, Lflyme/support/v7/widget/RecyclerView;->onEnterLayoutOrScroll()V
    ...
    iget-object v5, v3, Lflyme/support/v7/widget/RecyclerView;->mState:Lflyme/support/v7/widget/RecyclerView$State;

    invoke-virtual {v3, v5}, Lflyme/support/v7/widget/RecyclerView;->fillRemainingScrollValues(Lflyme/support/v7/widget/RecyclerView$State;)V
    ...
    iget-object v5, v5, Lflyme/support/v7/widget/RecyclerView;->mRecycler:Lflyme/support/v7/widget/RecyclerView$Recycler;

    iget-object v7, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    iget-object v7, v7, Lflyme/support/v7/widget/RecyclerView;->mState:Lflyme/support/v7/widget/RecyclerView$State;

    invoke-virtual {v3, v13, v5, v7}, Lflyme/support/v7/widget/RecyclerView$LayoutManager;->scrollHorizontallyBy(ILflyme/support/v7/widget/RecyclerView$Recycler;Lflyme/support/v7/widget/RecyclerView$State;)I
    ...
    iget-object v7, v7, Lflyme/support/v7/widget/RecyclerView;->mLayout:Lflyme/support/v7/widget/RecyclerView$LayoutManager;

    iget-object v8, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    iget-object v8, v8, Lflyme/support/v7/widget/RecyclerView;->mRecycler:Lflyme/support/v7/widget/RecyclerView$Recycler;

    iget-object v9, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    iget-object v9, v9, Lflyme/support/v7/widget/RecyclerView;->mState:Lflyme/support/v7/widget/RecyclerView$State;

    invoke-virtual {v7, v14, v8, v9}, Lflyme/support/v7/widget/RecyclerView$LayoutManager;->scrollVerticallyBy(ILflyme/support/v7/widget/RecyclerView$Recycler;Lflyme/support/v7/widget/RecyclerView$State;)I
    ...
    invoke-virtual {v9}, Lflyme/support/v7/widget/RecyclerView;->repositionShadowingViews()V

    .line 5030
    iget-object v9, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    invoke-virtual {v9}, Lflyme/support/v7/widget/RecyclerView;->onExitLayoutOrScroll()V

    .line 5031
    iget-object v9, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    invoke-virtual {v9, v4}, Lflyme/support/v7/widget/RecyclerView;->stopInterceptRequestLayout(Z)V
    ...
    invoke-virtual {v9}, Lflyme/support/v7/widget/RecyclerView$State;->getItemCount()I
    ...
    .line 5039
    invoke-virtual {v2, v9}, Lflyme/support/v7/widget/RecyclerView$SmoothScroller;->setTargetPosition(I)V
    ...
    .line 5040
    invoke-static {v2, v9, v10}, Lflyme/support/v7/widget/RecyclerView$SmoothScroller;->access$600(Lflyme/support/v7/widget/RecyclerView$SmoothScroller;II)V
    ...
    iget-object v9, v9, Lflyme/support/v7/widget/RecyclerView;->mItemDecorations:Ljava/util/ArrayList;
    ...
    invoke-virtual {v9}, Lflyme/support/v7/widget/RecyclerView;->invalidate()V

    .line 5049
    :cond_8
    iget-object v9, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    invoke-virtual {v9}, Lflyme/support/v7/widget/RecyclerView;->getOverScrollMode()I
    ...
    invoke-virtual {v9, v13, v14}, Lflyme/support/v7/widget/RecyclerView;->considerReleasingGlowsOnScroll(II)V

    .line 5053
    :cond_9
    iget-object v15, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;
    ...
    .line 5068
    :goto_4
    iget-object v4, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    invoke-virtual {v4}, Lflyme/support/v7/widget/RecyclerView;->getOverScrollMode()I
    ...
    invoke-virtual {v4, v15, v9}, Lflyme/support/v7/widget/RecyclerView;->absorbGlows(II)V
    ...
    invoke-virtual {v4, v3, v7}, Lflyme/support/v7/widget/RecyclerView;->dispatchOnScrolled(II)V

    .line 5080
    :cond_14
    iget-object v4, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    invoke-static {v4}, Lflyme/support/v7/widget/RecyclerView;->access$700(Lflyme/support/v7/widget/RecyclerView;)Z
    ...
    iget-object v4, v4, Lflyme/support/v7/widget/RecyclerView;->mLayout:Lflyme/support/v7/widget/RecyclerView$LayoutManager;

    invoke-virtual {v4}, Lflyme/support/v7/widget/RecyclerView$LayoutManager;->canScrollVertically()Z
    ...
    invoke-virtual {v7}, Lflyme/support/v7/widget/RecyclerView$LayoutManager;->canScrollHorizontally()Z
    ...
    invoke-static {v4}, Lflyme/support/v7/widget/RecyclerView;->access$800(Lflyme/support/v7/widget/RecyclerView;)I

    move-result v7

    add-int/2addr v7, v5

    invoke-static {v4, v7}, Lflyme/support/v7/widget/RecyclerView;->access$802(Lflyme/support/v7/widget/RecyclerView;I)I

    .line 5092
    iget-object v4, v0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;

    invoke-static {v4}, Lflyme/support/v7/widget/RecyclerView;->access$900(Lflyme/support/v7/widget/RecyclerView;)I

    move-result v5

    add-int/2addr v5, v8

    invoke-static {v4, v5}, Lflyme/support/v7/widget/RecyclerView;->access$902(Lflyme/support/v7/widget/RecyclerView;I)I
    ...
    invoke-static {v5}, Lflyme/support/v7/widget/RecyclerView;->access$1000(Lflyme/support/v7/widget/RecyclerView;)I
    ...
    invoke-static {v5}, Lflyme/support/v7/widget/RecyclerView;->access$1100(Lflyme/support/v7/widget/RecyclerView;)I
    ...
    .line 5097
    invoke-virtual {v1, v6}, Lflyme/support/v7/widget/RecyclerView;->hasNestedScrollingParent(I)Z
    ...
    iget-object v1, v1, Lflyme/support/v7/widget/RecyclerView;->mGapWorker:Lflyme/support/v7/widget/GapWorker;
    ...
    invoke-virtual {v1, v3, v13, v14}, Lflyme/support/v7/widget/GapWorker;->postFromTraversal(Lflyme/support/v7/widget/RecyclerView;II)V
    ...
    invoke-virtual {v1, v3}, Lflyme/support/v7/widget/RecyclerView;->setScrollState(I)V
    ...
    invoke-virtual {v1, v6}, Lflyme/support/v7/widget/RecyclerView;->stopNestedScroll(I)V
    ...
    .line 5115
    invoke-static {v2, v1, v1}, Lflyme/support/v7/widget/RecyclerView$SmoothScroller;->access$600(Lflyme/support/v7/widget/RecyclerView$SmoothScroller;II)V
...
.method public smoothScrollBy(IIILandroid/view/animation/Interpolator;)V
    ...
    iget-object v1, p0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Lflyme/support/v7/widget/RecyclerView;
    ...
    .line 5205
    iget-object v0, p0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mScroller:Landroid/widget/OverScroller;
    ...
    .line 5210
    iget-object p1, p0, Lflyme/support/v7/widget/RecyclerView$ViewFlinger;->mScroller:Landroid/widget/OverScroller;
...
.method public stop()V
    ...
    invoke-static {v0}, Lflyme/support/v7/widget/RecyclerView;->access$1300(Lflyme/support/v7/widget/RecyclerView;)V
