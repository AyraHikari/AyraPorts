...
.method private static requestAdvertisingIdInfo(Landroid/content/Context;)Lcom/huawei/hms/ads/identifier/AdvertisingIdClient$Info;
    ...
    new-instance v3, LXI/a/a/a/a/b;

    invoke-direct {v3}, LXI/a/a/a/a/b;-><init>()V
    ...
    :try_start_1
    iget-boolean v5, v3, LXI/a/a/a/a/b;->b:Z

    if-nez v5, :cond_1

    iput-boolean v2, v3, LXI/a/a/a/a/b;->b:Z

    iget-object v5, v3, LXI/a/a/a/a/b;->c:Ljava/util/concurrent/LinkedBlockingQueue;
...
.method private static updateAdvertisingIdInfo(Landroid/content/Context;)V
    ...
    sget-object v0, LXI/a/a/a/a/a;->a:Ljava/util/concurrent/ThreadPoolExecutor;
