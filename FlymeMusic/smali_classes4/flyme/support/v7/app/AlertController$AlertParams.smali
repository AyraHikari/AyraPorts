...
.field public mHighLightButton:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 878
    iput v0, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mHighLightColor:I
...
.method private createListView(Lflyme/support/v7/app/AlertController;)V
    ...
    .line 965
    iget-object v1, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mCursor:Landroid/database/Cursor;
    ...
    iget-object v1, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mLabelColumn:Ljava/lang/String;
    ...
    iget-object v1, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mContext:Landroid/content/Context;

    iget-object v3, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mItems:[Ljava/lang/CharSequence;

    invoke-direct {v9, v1, v4, v2, v3}, Lflyme/support/v7/app/AlertController$CheckedItemAdapter;-><init>(Landroid/content/Context;II[Ljava/lang/CharSequence;)V
...
.method public apply(Lflyme/support/v7/app/AlertController;)V
    ...
    .line 930
    :cond_8
    iget-object v9, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mNegativeButtonText:Ljava/lang/CharSequence;
    ...
    .line 931
    iget-object v10, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mNegativeButtonListener:Landroid/content/DialogInterface$OnClickListener;

    const/4 v11, 0x0

    iget-object v12, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mNegativeButtonIcon:Landroid/graphics/drawable/Drawable;

    move-object v7, p1

    invoke-virtual/range {v7 .. v12}, Lflyme/support/v7/app/AlertController;->setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;Landroid/graphics/drawable/Drawable;)V

    .line 933
    :cond_a
    iget-object v2, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mNeutralButtonText:Ljava/lang/CharSequence;
    ...
    .line 934
    iget-object v3, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mNeutralButtonListener:Landroid/content/DialogInterface$OnClickListener;

    const/4 v4, 0x0

    iget-object v5, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mNeutralButtonIcon:Landroid/graphics/drawable/Drawable;
    ...
    .line 947
    :cond_10
    iget v0, p0, Lflyme/support/v7/app/AlertController$AlertParams;->mViewLayoutResId:I

    if-eqz v0, :cond_11

    .line 948
    invoke-virtual {p1, v0}, Lflyme/support/v7/app/AlertController;->setView(I)V
