.class public Lcom/meizu/media/gallery/external/entities/a/g$6;
...
.method constructor <init>(Lcom/meizu/media/gallery/external/entities/a/g;Landroid/arch/persistence/room/RoomDatabase;)V
    ...
    .line 144
    iput-object p1, p0, Lcom/meizu/media/gallery/external/entities/a/g$6;->a:Lcom/meizu/media/gallery/external/entities/a/g;
...
.method public a(Landroid/arch/persistence/db/SupportSQLiteStatement;Lcom/meizu/media/gallery/external/entities/a/a;)V
    ...
    sget-object v3, Lcom/meizu/media/gallery/external/entities/a/g$6;->changeQuickRedirect:Lcom/meizu/savior/ChangeQuickRedirect;
    ...
    .line 170
    iget v1, p2, Lcom/meizu/media/gallery/external/entities/a/a;->i:I
...
.method public synthetic bind(Landroid/arch/persistence/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/meizu/media/gallery/external/entities/a/g$6;->a(Landroid/arch/persistence/db/SupportSQLiteStatement;Lcom/meizu/media/gallery/external/entities/a/a;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `faces` SET `_id` = ?,`media_id` = ?,`face_id` = ?,`confidence` = ?,`face_count` = ?,`feature` = ?,`is_cover` = ?,`rect` = ?,`rotation` = ? WHERE `_id` = ?"
