...
.field private final mPackageManagerProxy:Lflyme/support/v7/permission/PackageManagerProxy;
...
.method private getParentGroup(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 204
    iget-object v0, p0, Lflyme/support/v7/permission/PermissionManager;->mAllPermissions:Ljava/util/Map;
...
.method private initLocalization()V
    ...
    iput-object v1, v0, Lflyme/support/v7/permission/PermissionManager;->mLocalizations:Ljava/util/Map;

    .line 44
    new-instance v2, Lflyme/support/v7/permission/Localization;

    sget v3, Lflyme/support/v7/appcompat/R$drawable;->mz_permission_net:I

    const/4 v4, 0x0

    const-string/jumbo v5, "\u8fde\u63a5\u7f51\u7edc"

    invoke-direct {v2, v4, v5, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    .line 45
    iget-object v1, v0, Lflyme/support/v7/permission/PermissionManager;->mLocalizations:Ljava/util/Map;
    ...
    const-string/jumbo v7, "\u83b7\u53d6\u4f4d\u7f6e\u4fe1\u606f"

    invoke-direct {v2, v6, v7, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v8, "\u62cd\u7167\u548c\u5f55\u50cf"

    invoke-direct {v2, v7, v8, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v9, "\u5f55\u5236\u97f3\u9891"

    invoke-direct {v2, v8, v9, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v10, "\u62e8\u6253\u7535\u8bdd\u6216\u83b7\u53d6\u624b\u673a\u72b6\u6001"

    invoke-direct {v2, v9, v10, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v11, "\u8bfb\u53d6\u6216\u53d1\u9001\u4fe1\u606f"

    invoke-direct {v2, v10, v11, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v12, "\u8bfb\u53d6\u6216\u4fee\u6539\u8054\u7cfb\u4eba"

    invoke-direct {v2, v11, v12, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v13, "\u8bfb\u53d6\u6216\u4fee\u6539\u901a\u8bdd\u8bb0\u5f55"

    invoke-direct {v2, v12, v13, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v14, "\u8bfb\u5199\u624b\u673a\u5b58\u50a8"

    invoke-direct {v2, v13, v14, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    invoke-direct {v2, v14, v15, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v13, "\u5f00\u542f\u548c\u5173\u95ed\u65e0\u7ebf\u7f51\u7edc"

    invoke-direct {v2, v14, v13, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v14, "\u8bfb\u53d6\u6216\u4fee\u6539\u65e5\u5386"
    ...
    invoke-direct {v2, v13, v15, v3}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    invoke-direct {v2, v4, v15, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    invoke-direct {v2, v6, v3, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v3, "\u62e8\u6253\u6216\u63a5\u542c SIP \u7535\u8bdd"

    invoke-direct {v2, v7, v3, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    invoke-direct {v2, v8, v15, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v3, "\u8bfb\u53d6\u624b\u673a\u72b6\u6001\u548c\u8bc6\u522b\u7801"

    invoke-direct {v2, v9, v3, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    invoke-direct {v2, v10, v15, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v3, "\u7ee7\u7eed\u8fdb\u884c\u6765\u81ea\u5176\u4ed6\u5e94\u7528\u7684\u901a\u8bdd"

    invoke-direct {v2, v11, v3, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    invoke-direct {v2, v12, v15, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    invoke-direct {v2, v3, v15, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v3, "\u4fee\u6539\u9ed8\u8ba4\u7535\u8bdd\u5e94\u7528"
    ...
    const-string/jumbo v3, "\u8bfb\u53d6\u77ed\u4fe1\u6216\u5f69\u4fe1"

    invoke-direct {v2, v4, v3, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v3, "\u63a5\u6536\u77ed\u4fe1"

    invoke-direct {v2, v8, v3, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v3, "\u63a5\u6536 WAP \u8baf\u606f"

    invoke-direct {v2, v10, v3, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v3, "\u4f7f\u7528\u9ea6\u514b\u98ce\u6216\u5f55\u97f3"
    ...
    const-string/jumbo v3, "\u83b7\u53d6\u786e\u5207\u4f4d\u7f6e\u4fe1\u606f"
    ...
    const-string/jumbo v3, "\u83b7\u53d6\u5927\u81f4\u4f4d\u7f6e\u4fe1\u606f"
    ...
    const-string/jumbo v3, "\u5e94\u7528\u5728\u540e\u53f0\u65f6\u83b7\u53d6\u4f4d\u7f6e\u4fe1\u606f"
    ...
    const-string/jumbo v3, "\u4fee\u6539\u7167\u7247\u3001\u5a92\u4f53\u5185\u5bb9\u548c\u6587\u4ef6"
    ...
    const-string/jumbo v3, "\u5f00\u542f\u6216\u5173\u95ed\u65e0\u7ebf\u7f51\u7edc"
    ...
    invoke-direct {v2, v6, v15, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v3, "\u8bfb\u53d6\u8eab\u4f53\u4f20\u611f\u5668\u6570\u636e"
    ...
    invoke-direct {v2, v7, v15, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
    ...
    const-string/jumbo v3, "\u8bc6\u522b\u5065\u8eab\u8fd0\u52a8\u7c7b\u578b\u548c\u72b6\u6001"
    ...
    invoke-direct {v2, v4, v5, v4}, Lflyme/support/v7/permission/Localization;-><init>(ILjava/lang/String;I)V
...
.method private insertGroupIfAbsent(Ljava/util/List;Ljava/lang/String;)Lflyme/support/v7/permission/PermissionGroup;
    ...
    invoke-direct {v0, p2, v1, v2}, Lflyme/support/v7/permission/PermissionGroup;-><init>(Ljava/lang/String;Lflyme/support/v7/permission/Localization;Lflyme/support/v7/permission/PackageManagerProxy;)V
...
.method private insertPermissionIfAbsent(Ljava/util/List;Ljava/lang/String;)Lflyme/support/v7/permission/Permission;
    ...
    .line 194
    invoke-virtual {p1, v0}, Lflyme/support/v7/permission/PermissionGroup;->addSubPermission(Lflyme/support/v7/permission/Permission;)V
...
# virtual methods
.method public getAllPermissions()Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 141
    invoke-virtual {p0, v0, v1}, Lflyme/support/v7/permission/PermissionManager;->getRequestPermission([Ljava/lang/String;Z)Ljava/util/List;
...
.method public getRequestPermission([Ljava/lang/String;Z)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 154
    invoke-direct {p0, v3}, Lflyme/support/v7/permission/PermissionManager;->isGroup(Ljava/lang/String;)Z
    ...
    .line 155
    invoke-direct {p0, v0, v3}, Lflyme/support/v7/permission/PermissionManager;->insertGroupIfAbsent(Ljava/util/List;Ljava/lang/String;)Lflyme/support/v7/permission/PermissionGroup;

    if-eqz p2, :cond_2

    .line 157
    iget-object v4, p0, Lflyme/support/v7/permission/PermissionManager;->mAllPermissions:Ljava/util/Map;
    ...
    .line 158
    invoke-direct {p0, v0, v4}, Lflyme/support/v7/permission/PermissionManager;->insertPermissionIfAbsent(Ljava/util/List;Ljava/lang/String;)Lflyme/support/v7/permission/Permission;
    ...
    check-cast p2, Lflyme/support/v7/permission/PermissionGroup;

    .line 167
    invoke-virtual {p2}, Lflyme/support/v7/permission/PermissionGroup;->getSubPermission()Ljava/util/List;
