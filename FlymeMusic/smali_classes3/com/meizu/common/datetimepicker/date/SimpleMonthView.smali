...
.method public drawMonthDay(Landroid/graphics/Canvas;IIIFFFFFF)V
    ...
    .line 71
    iget-object p7, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mMonthNumPaint:Landroid/graphics/Paint;

    iget p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mDisabledDayTextColor:I

    invoke-virtual {p7, p8}, Landroid/graphics/Paint;->setColor(I)V

    .line 72
    iget-object p7, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mMonthDayLabelPaint:Landroid/graphics/Paint;
    ...
    .line 73
    iget-object p7, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventRemindPaint:Landroid/graphics/Paint;
    ...
    .line 74
    :cond_0
    iget p7, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mSelectedDay:I
    ...
    iget p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mSelectDayColor:I
    ...
    iget p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mSelectPaintAlpha:I
    ...
    .line 79
    :cond_1
    iget-boolean p7, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mHasToday:Z

    if-eqz p7, :cond_2

    iget p7, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mToday:I
    ...
    iget p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mTodayNumberColor:I
    ...
    iget p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventRemindColor:I
    ...
    iget p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mDayTextColor:I
    ...
    iget p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mLunarColor:I
    ...
    iget p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mLunarPaintAlpha:I
    ...
    .line 92
    iget p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mGregorianMarginTop:I
    ...
    .line 94
    iget-object p8, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mMonthNumFontMetrics:Landroid/graphics/Paint$FontMetricsInt;
    ...
    iget p10, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mPaddingOffset:I

    int-to-float p10, p10

    add-float/2addr p8, p10

    iget-object p10, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mMonthLunarLabelFontMetrics:Landroid/graphics/Paint$FontMetricsInt;
    ...
    .line 96
    iget p10, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventDotMarginTop:I

    int-to-float p10, p10

    add-float/2addr p10, p8

    iget v0, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventRemindRadios:F

    add-float/2addr p10, v0

    iget-object v0, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mMonthLunarLabelFontMetrics:Landroid/graphics/Paint$FontMetricsInt;
    ...
    iget v1, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventRemindRadios:F
    ...
    iget p10, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventRemindRadios:F
    ...
    .line 115
    iget p9, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mBgMarginTop:I
    ...
    .line 119
    :cond_6
    iget p9, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mBgPaddingLeftRight:I
    ...
    iget-object v0, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mSelectedCirclePaint:Landroid/graphics/Paint;
    ...
    invoke-static {v1, v2, p6}, Lcom/meizu/common/util/LunarCalendar;->solarToLunar(III)[I
    ...
    iget-object p3, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mMonthDayLabelPaint:Landroid/graphics/Paint;
    ...
    .line 162
    iget p3, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventRemindRadios:F
    ...
    .line 164
    iget p3, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventRemindWidth:F
    ...
    iget p4, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventRemindRadios:F

    iget-object p5, p0, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEventRemindPaint:Landroid/graphics/Paint;
...
.method protected drawMonthNums(Landroid/graphics/Canvas;)V
    ...
    .line 173
    invoke-virtual/range {p0 .. p0}, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->findDayOffset()I
    ...
    .line 177
    :goto_0
    iget v0, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mNumCells:I

    if-gt v15, v0, :cond_2

    .line 179
    iget-boolean v0, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->isRTL:Z

    if-eqz v0, :cond_0

    .line 181
    iget-object v0, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mTempRect:Landroid/graphics/RectF;

    iget v1, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mNumDays:I

    sub-int/2addr v1, v14

    sub-int/2addr v1, v12

    iget v2, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mCellWidth:I

    mul-int v1, v1, v2

    iget v2, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mEdgePadding:I

    add-int/2addr v1, v2

    iget v2, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mOffsetX:I
    ...
    iget-object v1, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mTempRect:Landroid/graphics/RectF;
    ...
    iget v1, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mCellWidth:I
    ...
    iget v1, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mRowHeight:I
    ...
    iget-object v1, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mMonthNumFontMetrics:Landroid/graphics/Paint$FontMetricsInt;
    ...
    .line 194
    iget v2, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mYear:I

    iget v3, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mMonth:I
    ...
    .line 199
    iget v0, v11, Lcom/meizu/common/datetimepicker/date/SimpleMonthView;->mNumDays:I
