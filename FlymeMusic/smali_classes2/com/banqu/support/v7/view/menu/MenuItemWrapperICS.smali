.class public Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;
.super Lcom/banqu/support/v7/view/menu/BaseMenuWrapper;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;,
        Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;,
        Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$OnActionExpandListenerWrapper;,
        Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$OnMenuItemClickListenerWrapper;
    }
.end annotation

.annotation system Ldalvik/annotation/Signature;
    value = {
        "Lcom/banqu/support/v7/view/menu/BaseMenuWrapper<",
...
.method constructor <init>(Landroid/content/Context;Landroidx/core/internal/view/SupportMenuItem;)V
    ...
    .line 53
    invoke-direct {p0, p1, p2}, Lcom/banqu/support/v7/view/menu/BaseMenuWrapper;-><init>(Landroid/content/Context;Ljava/lang/Object;)V
...
.method public collapseActionView()Z
    ...
    .line 285
    iget-object v0, p0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;->mWrappedObject:Ljava/lang/Object;
...
.method createActionProviderWrapper(Landroid/view/ActionProvider;)Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;
    ...
    .line 313
    new-instance v0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;

    iget-object v1, p0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;->mContext:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p1}, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;-><init>(Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;Landroid/content/Context;Landroid/view/ActionProvider;)V
...
.method public getActionProvider()Landroid/view/ActionProvider;
    ...
    .line 272
    instance-of v1, v0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;

    if-eqz v1, :cond_0

    .line 273
    check-cast v0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;

    iget-object v0, v0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;->mInner:Landroid/view/ActionProvider;
...
.method public getActionView()Landroid/view/View;
    ...
    .line 256
    instance-of v1, v0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;

    if-eqz v1, :cond_0

    .line 257
    check-cast v0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;

    invoke-virtual {v0}, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;->getWrappedView()Landroid/view/View;
...
.method public getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-virtual {p0, v0}, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;->getSubMenuWrapper(Landroid/view/SubMenu;)Landroid/view/SubMenu;
...
.method public setActionProvider(Landroid/view/ActionProvider;)Landroid/view/MenuItem;
    ...
    .line 265
    invoke-virtual {p0, p1}, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;->createActionProviderWrapper(Landroid/view/ActionProvider;)Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$ActionProviderWrapper;
...
.method public setActionView(I)Landroid/view/MenuItem;
    ...
    .line 245
    iget-object p1, p0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;->mWrappedObject:Ljava/lang/Object;
    ...
    new-instance v1, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;

    invoke-direct {v1, p1}, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;-><init>(Landroid/view/View;)V
...
.method public setActionView(Landroid/view/View;)Landroid/view/MenuItem;
    ...
    .line 234
    new-instance v0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;

    invoke-direct {v0, p1}, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$CollapsibleActionViewWrapper;-><init>(Landroid/view/View;)V
...
.method public setExclusiveCheckable(Z)V
    ...
    .line 302
    :try_start_0
    iget-object v0, p0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;->mSetExclusiveCheckableMethod:Ljava/lang/reflect/Method;
    ...
    iput-object v0, p0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;->mSetExclusiveCheckableMethod:Ljava/lang/reflect/Method;

    .line 306
    :cond_0
    iget-object v0, p0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;->mSetExclusiveCheckableMethod:Ljava/lang/reflect/Method;

    iget-object v3, p0, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;->mWrappedObject:Ljava/lang/Object;
...
.method public setOnActionExpandListener(Landroid/view/MenuItem$OnActionExpandListener;)Landroid/view/MenuItem;
    ...
    new-instance v1, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$OnActionExpandListenerWrapper;

    invoke-direct {v1, p0, p1}, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$OnActionExpandListenerWrapper;-><init>(Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;Landroid/view/MenuItem$OnActionExpandListener;)V
...
.method public setOnMenuItemClickListener(Landroid/view/MenuItem$OnMenuItemClickListener;)Landroid/view/MenuItem;
    ...
    new-instance v1, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$OnMenuItemClickListenerWrapper;

    invoke-direct {v1, p0, p1}, Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS$OnMenuItemClickListenerWrapper;-><init>(Lcom/banqu/support/v7/view/menu/MenuItemWrapperICS;Landroid/view/MenuItem$OnMenuItemClickListener;)V
...
.method public setTitleColor(Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;
    ...
    instance-of v0, v0, Lcom/banqu/support/v7/view/menu/MenuItemImpl;
    ...
    invoke-virtual {v0, p1}, Lcom/banqu/support/v7/view/menu/MenuItemImpl;->setTitleColor(Landroid/content/res/ColorStateList;)Landroid/view/MenuItem;
