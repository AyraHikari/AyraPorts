...
.method public static actionBarHomeAsUpOnScrolling(Landroid/app/Activity;IIZIII)V
    ...
    .line 257
    invoke-static {p0, p3, p4, p5}, Lcom/meizu/common/util/ResourceUtils;->getGradualColor(IIFI)I
...
.method public static getActionBarHeight(Landroid/content/Context;)I
    ...
    sget v0, Lcom/meizu/common/R$dimen;->mz_action_bar_default_height:I
...
.method public static getBackgroundAnimation(Landroid/view/View;II)Landroid/animation/ValueAnimator;
    ...
    .line 161
    new-instance p2, Lcom/meizu/common/util/ResourceUtils$1;

    invoke-direct {p2, p0}, Lcom/meizu/common/util/ResourceUtils$1;-><init>(Landroid/view/View;)V
...
.method public static getNightModeColor(Landroid/content/Context;)I
    ...
    sput p0, Lcom/meizu/common/util/ResourceUtils;->mNightModeColor:I
    :try_end_0
    ...
    :cond_0
    :goto_0
    sget p0, Lcom/meizu/common/util/ResourceUtils;->mNightModeColor:I
...
.method public static startBrightnessAnim(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_2
    :goto_0
    const-string p0, "you should setBounds for drawable before start brightness anim"
