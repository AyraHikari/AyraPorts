.class public Lorg/ijkplayer/IjkMediaCodecInfo;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lorg/ijkplayer/IjkMediaCodecInfo;->mRank:I

    return-void
.end method

.method private static getKnownCodecList()Ljava/util/Map;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-class v0, Lorg/ijkplayer/IjkMediaCodecInfo;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lorg/ijkplayer/IjkMediaCodecInfo;->sKnownCodecList:Ljava/util/Map;
    ...
    sput-object v1, Lorg/ijkplayer/IjkMediaCodecInfo;->sKnownCodecList:Ljava/util/Map;
...
.method public static getProfileLevelName(II)Ljava/lang/String;
    ...
    invoke-static {p0}, Lorg/ijkplayer/IjkMediaCodecInfo;->getProfileName(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lorg/ijkplayer/IjkMediaCodecInfo;->getLevelName(I)Ljava/lang/String;
...
.method public static setupCandidate(Landroid/media/MediaCodecInfo;Ljava/lang/String;)Lorg/ijkplayer/IjkMediaCodecInfo;
    .locals 3
    ...
    :cond_2
    invoke-static {}, Lorg/ijkplayer/IjkMediaCodecInfo;->getKnownCodecList()Ljava/util/Map;
    ...
    :cond_6
    :goto_0
    new-instance v0, Lorg/ijkplayer/IjkMediaCodecInfo;

    invoke-direct {v0}, Lorg/ijkplayer/IjkMediaCodecInfo;-><init>()V

    iput-object p0, v0, Lorg/ijkplayer/IjkMediaCodecInfo;->mCodecInfo:Landroid/media/MediaCodecInfo;

    iput v2, v0, Lorg/ijkplayer/IjkMediaCodecInfo;->mRank:I

    iput-object p1, v0, Lorg/ijkplayer/IjkMediaCodecInfo;->mMimeType:Ljava/lang/String;
...
.method public dumpProfileLevels(Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    iget-object v1, p0, Lorg/ijkplayer/IjkMediaCodecInfo;->mCodecInfo:Landroid/media/MediaCodecInfo;
    ...
    invoke-static {v4, v3}, Lorg/ijkplayer/IjkMediaCodecInfo;->getProfileLevelName(II)Ljava/lang/String;
