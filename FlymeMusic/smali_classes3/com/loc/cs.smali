...
.method private static a(Landroid/util/LongSparseArray;J)S
    ...
    iget-wide v6, p1, Lcom/loc/cs$a;->b:J
    ...
    iget-boolean p1, p1, Lcom/loc/cs$a;->c:Z
...
.method private static a(Ljava/util/List;Landroid/util/LongSparseArray;Landroid/util/LongSparseArray;)V
    ...
    new-instance v2, Lcom/loc/cs$a;

    invoke-direct {v2, v3}, Lcom/loc/cs$a;-><init>(B)V

    invoke-interface {p1}, Lcom/loc/cr;->b()I

    move-result v4

    iput v4, v2, Lcom/loc/cs$a;->a:I

    iput-wide v0, v2, Lcom/loc/cs$a;->b:J

    iput-boolean v3, v2, Lcom/loc/cs$a;->c:Z

    invoke-interface {p1}, Lcom/loc/cr;->a()J
    ...
    check-cast v2, Lcom/loc/cr;

    invoke-interface {v2}, Lcom/loc/cr;->a()J
    ...
    check-cast v6, Lcom/loc/cs$a;

    const/4 v7, 0x1

    if-nez v6, :cond_2

    new-instance v6, Lcom/loc/cs$a;

    invoke-direct {v6, v3}, Lcom/loc/cs$a;-><init>(B)V

    :goto_2
    invoke-interface {v2}, Lcom/loc/cr;->b()I

    move-result v2

    iput v2, v6, Lcom/loc/cs$a;->a:I

    iput-wide v0, v6, Lcom/loc/cs$a;->b:J

    iput-boolean v7, v6, Lcom/loc/cs$a;->c:Z

    goto :goto_3

    :cond_2
    iget v8, v6, Lcom/loc/cs$a;->a:I
...
.method final a(Ljava/util/List;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/loc/cs;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/loc/cs;->a:Landroid/util/LongSparseArray;

    iget-object v2, p0, Lcom/loc/cs;->b:Landroid/util/LongSparseArray;

    invoke-static {p1, v1, v2}, Lcom/loc/cs;->a(Ljava/util/List;Landroid/util/LongSparseArray;Landroid/util/LongSparseArray;)V

    iget-object p1, p0, Lcom/loc/cs;->a:Landroid/util/LongSparseArray;

    iget-object v1, p0, Lcom/loc/cs;->b:Landroid/util/LongSparseArray;

    iput-object v1, p0, Lcom/loc/cs;->a:Landroid/util/LongSparseArray;

    iput-object p1, p0, Lcom/loc/cs;->b:Landroid/util/LongSparseArray;
...
.method final b(Ljava/util/List;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/loc/cs;->f:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/loc/cs;->c:Landroid/util/LongSparseArray;

    iget-object v2, p0, Lcom/loc/cs;->d:Landroid/util/LongSparseArray;

    invoke-static {p1, v1, v2}, Lcom/loc/cs;->a(Ljava/util/List;Landroid/util/LongSparseArray;Landroid/util/LongSparseArray;)V

    iget-object p1, p0, Lcom/loc/cs;->c:Landroid/util/LongSparseArray;

    iget-object v1, p0, Lcom/loc/cs;->d:Landroid/util/LongSparseArray;

    iput-object v1, p0, Lcom/loc/cs;->c:Landroid/util/LongSparseArray;

    iput-object p1, p0, Lcom/loc/cs;->d:Landroid/util/LongSparseArray;
